...
import {SecurityRounded, VerifiedUserTwoTone} from '@mui/icons-material';
...
export const Loading = () => {
    ...
    const sxShield1: SxProps = {
        ...sxShieldBase,
        color: '#52b90f',
        opacity: animationStage > 50 ? 0 : 1
    }
    const sxShield2: SxProps = {
        ...sxShieldBase,
        opacity: animationStage / 100
    }
