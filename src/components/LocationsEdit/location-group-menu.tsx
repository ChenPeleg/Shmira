...
export const LocationGroupMenu = (props: LocationGroupMenuProps) => {
  ...
  return (
    ...
    >
      <MenuItem
        onClick={(e) =>
          handleLocationGroupMenuClick(e, LocationGroupActionType.Rename)
        }
      >
      ...
      <MenuItem
        onClick={(e) =>
          handleLocationGroupMenuClick(e, LocationGroupActionType.Delete)
        }
      >
        <Delete />
        &nbsp;
      ...
      <MenuItem
        onClick={(e) =>
          handleLocationGroupMenuClick(e, LocationGroupActionType.CreateCopy)
        }
      >
        <FileCopy />
        &nbsp;
