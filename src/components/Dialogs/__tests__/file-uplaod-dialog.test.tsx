...
describe('File Upload Dialog', () => {
    ...
    beforeEach(async () => {
        onClose = jest.fn();
         ...
         render(fileDialog)
         component =await screen.getByRole('dialog', {hidden: true}) as HTMLElement;
    ...
    it('closes dialog on press cancel', async () => {
        const target: TargetElement = component?.querySelector('#file-upload-cancel-button') as TargetElement
