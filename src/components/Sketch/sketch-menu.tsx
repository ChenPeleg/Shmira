...
export const SketchMenu = (props: SketchMenuProps) => {
  ...
  return (
    ...
    >
      <MenuItem
        onClick={(e) => handleSketchMenuClick(e, SketchActionType.Rename)}
      >
        <DriveFileRenameOutline />
        &nbsp;
        {translations.Rename}
      ...
      <MenuItem
        onClick={(e) => handleSketchMenuClick(e, SketchActionType.Delete)}
      >
        <Delete />
        &nbsp;
        {translations.Delete}
      ...
      <MenuItem
        onClick={(e) => handleSketchMenuClick(e, SketchActionType.CreateCopy)}
      >
        <FileCopy />
        &nbsp;
      ...
      <MenuItem
        onClick={(e) => handleSketchMenuClick(e, SketchActionType.Archive)}
      >
        <Archive /> &nbsp;
